...
{
    public class TravelVripPromotionContractPageViewModel : ObservableObject
    {
        #region Properties
        ...
        private async Task GetTravelVripData()
        {
            ...
            TravelPageUiModel = await ((App)Application.Current).QueryService.GetTravelDataForCustomer(CustomerPageViewModel.CustomerId);
            VripPageUiModel = await ((App)Application.Current).QueryService.GetVripDataForCustomer(CustomerPageViewModel.CustomerId);
        ...
        private async Task FetchPromotionData()
        {
            ...
            DbPromotionDataSource = await ((App)Application.Current).QueryService.GetPromotionDataForCustomer(CustomerPageViewModel.CustomerId);
        ...
        {
            DbContractDataSource = await ((App)Application.Current).QueryService.GetContractsDataForCustomer(CustomerPageViewModel.CustomerId);
