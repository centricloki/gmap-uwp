        ...
        public string BuildEmailBody(List<OrderDetails> Body, CustomerInfo customerInfo, string SalesType, string BrandImagePath, List<string> TemplateToLoad)
        {
            ...
            foreach (OrderDetails item in Body)
            {
                if (SalesType == "2")
                    ItemDetails = "<tr><td style ='text-align: center; padding: 5px;border-bottom:1px solid black;'>" + item.ProductName +
                         ...
                         "</td><td style='text-align: center; padding: 5px;border-bottom:1px solid black;border-left:1px solid black;' colspan='100'>" + item.Quantity + "</td></tr>";
                if (SalesType == "3")
                    ItemDetails = "<tr><td style ='text-align: center; padding: 5px;border-bottom:1px solid black;'>" + item.ProductName +
                       "</td><td style='text-align: center; padding: 5px;border-bottom:1px solid black;border-left:1px solid black;'>" + item.Description +
                       "</td><td style='text-align: center; padding: 5px;border-bottom:1px solid black;border-left:1px solid black;'>" + item.UOM +
                ...
                if (SalesType == "4" || SalesType == "1" || SalesType == "9" || SalesType == "11" || SalesType == "12" || SalesType == "13" || SalesType == "14")
                {
                    ItemDetails = "<tr><td style ='text-align: center;border-left:1px solid black;border-bottom:1px solid black;'>" + item.ProductName +
                         ...
                         "</td><td style='text-align: center; padding: 5px;border-left:1px solid black;border-bottom:1px solid black;' colspan='100'>" + ((item.Price * item.Quantity).ToString("C2")) +
                         "</td></tr>";
                }
                if (SalesType == "6")
                {
                    ItemDetails = "<tr><td style ='text-align: center; padding: 5px;border-bottom:1px solid black;'>" + item.ProductName +
                         "</td><td style='text-align: center; padding: 5px;border-left:1px solid black;border-bottom:1px solid black;'>" + item.Description +
                         "</td><td style='text-align: center; padding: 5px;border-left:1px solid black;border-bottom:1px solid black;'>" + item.UOM +
                         "</td><td style='text-align: center; padding: 5px;border-left:1px solid black;border-bottom:1px solid black;' colspan='100'>" + item.Quantity + "</td></tr>";
                ...
                if (SalesType == "2")
                    DistributorName = item.RetailDistributorNumber;
                else DistributorName = item.DistributorName;
            ...
            if (SalesType == "2")
            {
                header = "<table width=800 style ='border-top:1px solid black;border-right:1px solid black;border-left:1px solid black; width:100%'><tr><td style='border:1px solid black; background-color:black; color: white; text-align: left' colspan=100 %>" +
                          ...
                          "Distributor UIN</th><th style ='border-bottom:1px solid black;border-left:1px solid black;'>Quantity" +
                          "</th></tr>";
            }
            //Lisa - new sales type for returns 3/24/16
            if (SalesType == "8")
            {
                header = "<table  style ='border-left:1px solid black;border-top:1px solid black; border-right:1px solid black;width:100%'><tr><td style='border-left:1px solid black;border-bottom:1px solid black; background-color:black; color: white; text-align: left' colspan=100 %>" +
                          "H" + "</td></tr>" +
                         "<tr><th style ='border-bottom:1px solid black;border-bottom:1px solid black;'>" +
                          ...
                          "Return Reason</th><th style ='border-left:1px solid black;border-bottom:1px solid black;' colspan='100'>Quantity" +
                          "</th></tr>";
            }
            if (SalesType == "3" || SalesType == "5" || SalesType == "10")//  salestype 10 added by senthil ramadoss on 10-01-2018
            {
                ...
                header = "<table style ='border-top:1px solid black;border-right:1px solid black;border-left:1px solid black; width:100%'><tr><td style='border:1px solid black; background-color:black; color: white; text-align: left' colspan=100 %>" +
                           "H" + "</td></tr>" +
                           "<tr><th style ='border-bottom:1px solid black;'>" +
                           "RT Item#</th><th style ='border-bottom:1px solid black;border-left:1px solid black;'>" +
                           "Description</th><th style ='border-bottom:1px solid black;border-left:1px solid black;'>" +
                           "UOM</th><th style ='border-bottom:1px solid black;border-left:1px solid black;' colspan='100'>Quantity" +
                           "</th></tr>";
            }

            if (SalesType == "4" || SalesType == "1" || SalesType == "9" || SalesType == "11" || SalesType == "12" || SalesType == "13" || SalesType == "14")
            {
                header = "<table style ='border-top:1px solid black; border-right:1px solid black;width:100%'><tr><td style='border:1px solid black; background-color:black; color: white; text-align: left' colspan='100'>" + "H" + "</td></tr>" +
                        ...
                        "</th><th style ='border-bottom:1px solid black;border-left:1px solid black;'>Quantity</th><th style ='border-bottom:1px solid black;border-left:1px solid black;' colspan='100'>Net Price</th></tr>";
                subtotalRowTP = "<tr><td></td><td></td><td></td><td></td><td style ='background-color:black; color: white; text-align: left'>Sub Total</td><td style='text-align: center; padding: 5px;border-bottom:1px solid black;' colspan='100'>" + SubTotalTP.ToString("C2") + "</td></tr>";
                subtotalRowNTP = "<tr><td></td><td></td><td></td><td></td><td style ='background-color:black; color: white; text-align: left'>Sub Total</td><td style='text-align: center; padding: 5px;border-bottom:1px solid black;' colspan='100'>" + SubTotalNTP.ToString("C2") + "</td></tr>";
            ...
            foreach (var t in Templates)
            {
                ...
                if (SalesType == "5" || SalesType == "10")//  salestype 10 added by senthil ramadoss on 10-01-2018
                {
                    if (!OrderXMLExist)
                    {
                        ...
                        if (!String.IsNullOrEmpty(customerInfo.CustomerComment))
                        {
                ...
                // string finalTemplate = FilledTemplate.Replace("cid:MyPic", "");
            }
