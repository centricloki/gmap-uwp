...
public class AdvanceGoogleMapPageViewModel : BaseModel
{
    #region Fields
    ...
    #region Constructor
    public AdvanceGoogleMapPageViewModel()
    {
        RegisterCommands();
    ...
    private async Task ApplyFilterAndFetchData()
    {
        ...
        if (FilterSelectedStartDate.HasValue && FilterSelectedEndDate.HasValue)
        {
            ...
            DisplayStartDate = SelectedStartDate.Value.DateTime.ToString(DRLMobile.Core.Helpers.DateTimeHelper.USDateFormat, new CultureInfo("en-US"));
            DisplayEndDate = SelectedEndDate.Value.DateTime.ToString(DRLMobile.Core.Helpers.DateTimeHelper.USDateFormat, new CultureInfo("en-US"));
        }
        else
        {
    ...
    private async Task ItemSearchHeaderTextChangeCommandHandler(string text)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(ItemSearchHeaderTextChangeCommandHandler), ex.StackTrace);
        }
    }
    ...
    private async Task ApplyItemLegendsFilter()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(ApplyItemLegendsFilter), ex.StackTrace + " - " + ex.Message);
        }
    }
    ...
    private async Task ApplyCashSalesLegendsFilterAsync()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(ApplyCashSalesLegendsFilterAsync), ex);
        }
    }
    ...
    private async Task ApplyCallDateLegendsFilterAsync()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(ApplyCallDateLegendsFilterAsync), ex.StackTrace + " - " + ex.Message);
        }
    }
    ...
    private async Task ApplyRankLegendsFilterAsync()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "ApplyRankLegendsFilter", ex.StackTrace + " - " + ex.Message);
        }
    }
    ...
    private async Task ApplyTradeTypeLegendsFilterAsync()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "ApplyTradeTypeLegendsFilterAsync", ex.StackTrace + " - " + ex.Message);
        }
    }
    ...
    private async Task RemoveItemsFromPointOfInterestSourceAsync(List<PointOfInterest> removedItems)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "RemoveItemsFromPointOfInterestSourceAsync", ex.StackTrace);
        }
    }
    ...
    private void RemoveItemsFromPointOfInterestSource(List<PointOfInterest> removedItems)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "RemoveItemsFromPointOfInterestSource", ex.StackTrace);
        }
    }
    ...
    public async Task OnNavigatedToCommandHandler()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(OnNavigatedToCommandHandler), ex.StackTrace);
        }
    }
    ...
    private void ClearHeaderFilterDiscription()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(ClearHeaderFilterDiscription), ex.StackTrace);
        }
    }
    ...
    private void SetDefaultZoneRegionTerritory()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(SetDefaultZoneRegionTerritory), ex.StackTrace);
        }
    }
    ...
    private async Task LoopAndAddToSourceForItemSourceAsync(List<MapCustomerData> tempList)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "LoopAndAddToSourceForItemSourceAsync", ex);
        }
    }
            ...
            foreach (var item in mapCustomerList)
            {
                if (!string.IsNullOrWhiteSpace(item.Latitude) && !string.IsNullOrWhiteSpace(item.Longitude))
                {
                    ...
                    if (legend?.IsSelected == true)
                    {
                        ...
                        {
                            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(LoopAndAddToSourceTradeTypeAsync), ex);
                        }
                    }
                }
            }
    ...
    private async Task PlotPinsForAccountRankFromSource(IEnumerable<MapCustomerData> source)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(PlotPinsForAccountRankFromSource), ex.StackTrace);
        }
    }
        ...
        foreach (var item in tempList)
        {
            if (!string.IsNullOrWhiteSpace(item.Latitude) && !string.IsNullOrWhiteSpace(item.Longitude))
            {
                ...
                if (legend?.IsSelected == true)
                {
                    ...
                    {
                        ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(LoopAndAddToSourceForRankAsync), ex);
                    }
                }
            }
        }
        ...
        foreach (var item in tempList)
        {
            if (!string.IsNullOrEmpty(item.LastCallActivityDate) && !string.IsNullOrWhiteSpace(item.Latitude) && !string.IsNullOrWhiteSpace(item.Longitude))
            {
                ...
                if (legend?.IsSelected == true && isValidDateCheck)
                {
                    ...
                    {
                        ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(LoopAndAddToSourceForCallDateAsync), ex);
                    }
                }
            }
        }
    ...
    private async Task PlotPinsForCashSalesFromSource(List<MapCustomerData> source)
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "PlotPinsForCashSalesFromSource", ex.StackTrace);
        }
    }
        ...
        foreach (var item in tempList)
        {
            ...
            if (!string.IsNullOrWhiteSpace(item.Latitude) && !string.IsNullOrWhiteSpace(item.Longitude))
            {
                ...
                if (legend?.IsSelected == true)
                {
                    ...
                    {
                        ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), "LoopAndAddToSourceForCashSalesAsync", ex.StackTrace);
                    }
                }
            }
        }
    ...
    private void GetPinTagsOnTheBasisOfCallDate()
    {
        ...
        {
            ErrorLogger.WriteToErrorLog(nameof(AdvanceGoogleMapPageViewModel), nameof(GetPinTagsOnTheBasisOfCallDate), ex);
        }
    }
