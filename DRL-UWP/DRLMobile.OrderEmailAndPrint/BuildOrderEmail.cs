...
namespace DRLMobile.OrderEmailAndPrint
{
    public class BuildOrderEmail
    {
        ...
        private readonly string xmlpath = @"C:\orderdataxml";
        private readonly string autoitem = @"TUOLTR";
        private readonly string autoitemqty = @"1";

        /// <summary>
        /// This method accepet the sales type and returns the sales type name
        /// </summary>
        /// <param name="salestype"></param>
        /// <returns>Sales type name</returns>
        //private string GetSaleTypeName(string salestype)
        //{
        //    string salesName = string.Empty;
        //    switch (salestype)
        //    {
        //        case "1":
        //            salesName = "Cash Sales";
        //            break;
        //        case "2":
        //            salesName = "Prebook";
        //            break;
        //        case "3":
        //            salesName = "Bill Through";
        //            break;
        //        case "4":
        //            salesName = "Suggested Order";
        //            break;
        //        case "5":
        //            salesName = "Rack_POS";
        //            break;
        //        case "6":
        //            salesName = "Distributor Order";
        //            break;
        //        case "7":
        //            salesName = "Distributor Invoice";
        //            break;
        //        case "8":
        //            salesName = "Credit_Request";
        //            break;
        //        case "9":
        //            salesName = "Cash Sales Initiative";
        //            break;
        //        case "10":
        //            salesName = "POP";
        //            break;
        //        case "11":
        //            salesName = "Sample Order";
        //            break;

        //        case "12":
        //            salesName = "Chain Distribution";
        //            break;

        //        case "13":
        //            salesName = "Credit Card Sales";
        //            break;
        //    }
        //    return salesName;
        //}
        ...
        /// <returns></returns>
        private List<string> LoadTemplate(string SalesTypeValue, string CustomerState)
        {
            string SalesTypeVal = string.Empty;
            int SalesType = Convert.ToInt32(SalesTypeValue);
            ResourceLoader resourceLoader = ResourceLoader.GetForCurrentView();
            
            List<string> Email = new List<string>();

            if (SalesType.Equals((int)Helper.SalesType.Cash_Sales))
            {
                Template = resourceLoader.GetString("TemplateRetailSale");
             //   Template = Properties.Resources.TemplateRetailSale;
            ...
            else if (SalesType.Equals((int)Helper.SalesType.Prebook))
            {
              ...
              //  Template = Properties.Resources.TemplateRetailPrebook;
                Templates.Add(Template);
            }
            else if (SalesType.Equals((int)Helper.SalesType.Bill_Through))
            {
                //SalesTypeVal = "BillThrough";
                Template = resourceLoader.GetString("TemplateRetailBillThrough");
              //  Template = Properties.Resources.TemplateRetailBillThrough;
                Templates.Add(Template);
            }
            else if (SalesType.Equals((int)Helper.SalesType.Suggested_Order))
            {
                // Template = Properties.Resources.TemplateSuggestedOrder;
                Template = resourceLoader.GetString("TemplateSuggestedOrder");
                Templates.Add(Template);
            }

            else if  (SalesType.Equals((int)Helper.SalesType.Rack_POS))
            {

               // SalesTypeVal = "Rack_POP";
                //Template = Properties.Resources.TemplateRackPop;//not completed
            ...
            {
               // SalesTypeVal = "DistributorOrder";
                //Template = Properties.Resources.TemplatePurchaseOrder;
                //Template1 = Properties.Resources.TemplateTopPurchaseOrder;
            ...
            {
                //SalesTypeVal = "CreditRequest";
                //Template = Properties.Resources.TemplateCreditRequest;
                //Template1 = Properties.Resources.TemplateTopCreditRequest;
            ...
            else  if (SalesType.Equals((int)Helper.SalesType.Cash_Sales_Initiative))
            {
                ...
                //SalesTypeVal = "CashSalesInitiative";
              // Template = Properties.Resources.TemplateCashSalesInitiative;
                Template = resourceLoader.GetString("TemplateCashSalesInitiative");

                Templates.Add(Template);
            }
            else if (SalesType.Equals((int)Helper.SalesType.POP))
            {
               // SalesTypeVal = "Rack_POP";
               // Template = Properties.Resources.TemplateRackPop;//not completed
                Template = resourceLoader.GetString("TemplateRackPop");
            ...
            {
                //SalesTypeVal = "Sample Order";
              //  Template = Properties.Resources.TemplateSampleOrder;
                Template = resourceLoader.GetString("TemplateSampleOrder");

                Templates.Add(Template);
            }
            else if (SalesType.Equals((int)Helper.SalesType.Chain_Distribution))
            {
               // SalesTypeVal = "Chain Distribution";
               // Template = Properties.Resources.TemplateRetailSale;
                Template = resourceLoader.GetString("TemplateRetailSale");
            ...
            //    //Lisa - added on 3/23/16; new sales type for returns

            else if  (SalesType.Equals((int)Helper.SalesType.Credit_Card_Sales))
            {
                //SalesTypeVal = "CardSales";
                //Template = Properties.Resources.TemplateCardSale;
        ...
        /// <returns></returns>
        public string BuildEmailBody(List<OrderDetails> Body, CustomerInfo customerInfo, string SalesType, string BrandImagePath)
        {

            List<string> Templates = LoadTemplate(SalesType, customerInfo.State);
            ...
            foreach (var t in Templates)
            {
                ...
                if (SalesType == "5" || SalesType == "10")//  salestype 10 added by senthil ramadoss on 10-01-2018
                {
                    if (!OrderXMLExist)
                    {
                        ...
                        //xmlbuildHeader.AppendLine("<AddressID></AddressID>");
                        ...
                        {
                            //List<string> coments = SplitWordsByLength(customerInfo.CustomerComment.Trim(), 200);
                            string[] coments = customerInfo.CustomerComment.Trim().Split(new[] { "\n" }, StringSplitOptions.None);
                            foreach (string com in coments)
                            {
                                string newcomtext = com.Trim();// com.Replace("\r\n", "");
