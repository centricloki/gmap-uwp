    ...
    public sealed partial class DashboardButton : UserControl
    {
        ...
        public string NormalStateImageSource
        {
            ...
            set { SetValue(NormalStateImageSourceProperty, value); 
                if (!string.IsNullOrWhiteSpace(value)) CurrentImgSource = new BitmapImage(new Uri(value));
            }
        }
        ...
        private void Button_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(HoverStateImageSource))
                CurrentImgSource = new BitmapImage(new Uri(HoverStateImageSource));
        }

        private void Button_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(HoverStateImageSource))
                CurrentImgSource = new BitmapImage(new Uri(NormalStateImageSource));
        }
        ...
        public ImageSource CurrentImgSource
        {
            get
            {
                return (ImageSource)GetValue(CurrentImgSourceProperty);
            }
            set { SetValue(CurrentImgSourceProperty, value); }
        }
        public static readonly DependencyProperty CurrentImgSourceProperty =
            DependencyProperty.Register(name: nameof(CurrentImgSourceProperty), propertyType: typeof(ImageSource),
               ownerType: typeof(DashboardButton),
